...
class PDF_MC_Table extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(130, 6, utf8_decode('F-121-05 - INVENTARIO ESTANDARIZADO DE ARCHIVO DE TRÁMITE'), 0, 2, 'L', 1);
        ...
        $this->Cell(45, 9, 'Consecutivo', 1, 0, 'C', 1);
        $this->Cell(45, 9, 'Nombre del expediente', 1, 0, 'C', 1);
        $this->Cell(45, 9, utf8_decode('Código de clasificación'), 1, 0, 'C', 1);
        $this->Cell(40, 9, utf8_decode('Ubicación'), 1, 0, 'C', 1);
        $this->Cell(35, 9, 'Apertura', 1, 0, 'C', 1);
        $this->Cell(35, 9, 'Cierre', 1, 0, 'C', 1);
        $this->Cell(15, 9, 'AT', 1, 0, 'C', 1);
    }
