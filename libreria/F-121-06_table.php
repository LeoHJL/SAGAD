...
class PDF_MC_Table extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(130, 6, utf8_decode('F-121-06 - INVENTARIO DE TRANSFERENCIA PRIMARIA'), 0, 2, 'L', 1);
        ...
        $this->SetFont('Arial', 'B', 10);
        $this->SetX(11);
        $this->Cell(15, 9, 'Caja', 1, 0, 'C', 1);
        $this->Cell(35, 9, 'Consecutivo', 1, 0, 'C', 1);
        $this->Cell(35, 9, 'Nombre expediente', 1, 0, 'C', 1);
        $this->Cell(35, 9, utf8_decode('Código clasificación'), 1, 0, 'C', 1);
        $this->Cell(30, 9, utf8_decode('Ubicación'), 1, 0, 'C', 1);
        $this->Cell(25, 9, 'Apertura', 1, 0, 'C', 1);
        $this->Cell(25, 9, 'Cierre', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'A', 1, 0, 'C', 1);
        $this->Cell(5.8, 9, 'J/L', 1, 0, 'C', 1);
        $this->Cell(5.8, 9, 'F/C', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'T', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'C', 1, 0, 'C', 1);
        $this->Cell(8, 9, 'Total', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'BD', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'H', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'M', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'D', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'P', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'R', 1, 0, 'C', 1);
        $this->Cell(5.4, 9, 'C', 1, 0, 'C', 1);
    }
