        ...
        <div class="formbg-outer">
          <div class="formbg">
            <div class="formbg-inner padding-horizontal--48">
              ...
              <span class="padding-bottom--15">Modifcacion del expediente</span>
              <!-- input Cvo -->
              <div class="field padding-bottom--24">
                <div class="grid--50-50">
                  <label for="password">Cvo</label>
                </div>
                <div class="form-icon">
                  <i class="fas fa-th-list"></i>
                  <!-- Autocompletado -->
                  <select id="Cvo" name="Cvo">
              ...
              <div class="field padding-bottom--24">
                ...
                <div class="field padding-bottom--24">
                  <button id="btn-primary" class="btn-primary">Modificar</button>
                </div>
              </div>
            </div>
          </div>
