        ...
        <div class="formbg-outer">
          <div class="formbg">
            ...
            <div class="formbg-inner padding-horizontal--48">
              ...
              <span class="padding-bottom--15">Registro de Unidades Administrativas</span>
              <div class="field padding-bottom--24">
                <label for="email">Identificador de Unidad Administrativa</label>
                <div class="form-icon">
                  <i class="fas fa-id-card-alt"></i>
                  <input type="text" name="text" id="Id_UA_UAC"> 
                </div>
              </div>
              <div class="field padding-bottom--24">
                <label for="email">Nombre de Unidad Administrativa</label>
                <div class="form-icon">
                  <i class="fas fa-users"></i>
                  <input type="text" name="Name_AP" id="Titu_UA_UAC">
                </div>
              </div>
              <div class="field padding-bottom--24">
                <div class="grid--50-50">
                  <label for="password">Titular de Unidad Administrativa</label>
                </div>
                <div class="form-icon">
                  <i class="fas fa-user-tie"></i>
                  <input type="text" name="Titu_AP" id="UA_UAC">
                </div>
              </div>
              <div class="field padding-bottom--24">
